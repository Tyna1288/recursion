...
function findFrom(board, word, y, x, seen) {
  //finding a word on board, starting at x, y, 
  //with what tiles have been seen so far and it is recursively to find smaller and smaller words until all tries are exhausted or success.
